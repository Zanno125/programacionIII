...
function startRouter(): Router 
{
    ...
    //TP ENTIDADES:
    include_once "Routes/ClubRoutes.php";
    $routes = array_merge($routes, ClubRoutes::getRoutes());

    include_once "Routes/ActivityRoutes.php";
    $routes = array_merge($routes, ActivityRoutes::getRoutes());
